...
#### Install
The installation of Fio.Chronicle has two parts, 1) configuration and 2) installation.
...
The options specified above would suit a minimal configuration but other configuration options may be found [here](docs/config-options.md) 
